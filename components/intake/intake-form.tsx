...
export function IntakeForm({ initialData }: IntakeFormProps) {
  ...
  async function saveAndExit() {
    startTransition(async () => {
      await saveIntakeData(form.getValues());
      router.push('/');
    });
  }
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      Primary Geography <span className="text-red-500">*</span>
                    </FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger className="w-full">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Target Customer Profile (ICP) <span className="text-red-500">*</span>
                  </FormLabel>
                  <FormControl>
                    <Textarea
          ...
          <div className="space-y-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Core Problem Statement <span className="text-red-500">*</span>
                  </FormLabel>
                  <FormControl>
                    <Textarea
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Proposed Solution Overview <span className="text-red-500">*</span>
                  </FormLabel>
                  <FormControl>
                    <Textarea
          ...
          <div className="space-y-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Revenue Model Structure <span className="text-red-500">*</span>
                  </FormLabel>
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger className="w-full">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Business Model Explanation <span className="text-red-500">*</span>
                  </FormLabel>
                  <FormControl>
                    <Textarea
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Competitive Differentiators <span className="text-red-500">*</span>
                  </FormLabel>
                  <FormControl>
                    <Textarea
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-400">
                      Founder accepts non-confidential evaluation terms and acknowledges that
                      synthesis results are for internal assessment only.
                    </p>
                  </div>
                </div>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button type="submit" size="sm" className="bg-blue-500 rounded-sm" disabled={isPending}>
            {isPending ? 'Saving...' : 'Review Fields'}
          </Button>
        </div>
      </form>
    </Form>
